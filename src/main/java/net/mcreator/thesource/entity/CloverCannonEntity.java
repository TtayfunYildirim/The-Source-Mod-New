...
import net.mcreator.thesource.procedures.CloverCannonOnInitialEntitySpawnProcedure;
...
public class CloverCannonEntity extends TheSourceModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clover_cannon").setRegistryName("clover_cannon");

	public CloverCannonEntity(TheSourceModElements instance) {
		super(instance, 48);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CloverCannonGeckolibEntity());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("clover_cannon_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob, IAnimatable {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			CloverCannonOnInitialEntitySpawnProcedure
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			FlamethrowerProjectileItem.shoot(this, target);
		}
