...
import net.mcreator.thesource.procedures.SetMaxFlowToProcedure;
...
public class SetMaxFlowCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("setmaxflow").requires(s -> s.hasPermissionLevel(4))
				.then(Commands.argument("number", DoubleArgumentType.doubleArg()).executes(arguments -> {
					...
					SetMaxFlowToProcedure.executeProcedure(
