...
import net.mcreator.thesource.procedures.SetFlowToProcedure;
...
public class SetFlowCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("setflow")
				...
				.then(Commands.argument("number", DoubleArgumentType.doubleArg()).executes(arguments -> {
					...
					SetFlowToProcedure.executeProcedure(
