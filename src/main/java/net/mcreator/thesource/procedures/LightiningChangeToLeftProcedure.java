...
public class LightiningChangeToLeftProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheSourceMod.LOGGER.warn("Failed to load dependency entity for procedure LightiningChangeToLeft!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		double lastopened = 0;
		lastopened = LastOpenedPowerLightiningProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
		...
		if ((entity.getCapability(TheSourceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new TheSourceModVariables.PlayerVariables())).selectedpower == 0) {
			{
				String _setval = "Nerve Wrecking Mode";
				entity.getCapability(TheSourceModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
			...
			{
				String _setval = "Lightining Strike";
				entity.getCapability(TheSourceModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.selectedskill = _setval;
					capability.syncPlayerVariables(entity);
				});
